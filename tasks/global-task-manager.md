...
|:---|:----------|:---------|:------|:-------|:-----|
| T006 | Substrate cleanup — POC findings (transition guards, list_record, name escaping, list flags) | High | Phase 2 (REVISE 1/3) | CODE_REVIEW | [main.md](./active/T006-substrate-cleanup-poc/main.md) |
