...
|:---|:----------|:---------|:------|:-------|:-----|
| T006 | Substrate cleanup — POC findings (transition guards, list_record, name escaping, list flags) | High | Phase 1 | EXECUTING_PHASE_1 | [main.md](./active/T006-substrate-cleanup-poc/main.md) |
