...
- **2026-05-10** — T144 landed the ResourceLock v1 substrate: `resource_locks` table via `SUBSTRATE_DDL`, `handlers::resource_locks` acquire/release/check/recover helpers with explicit invokers, and audited `stores resource-locks` CLI verbs.
